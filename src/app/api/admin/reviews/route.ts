...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('Session check for reviews:', {
      exists: !!session,
    ...
    const apiUrl = `${API_URL}/admin/reviews${queryParams ? `?${queryParams}` : ""}`;
    console.log('Forwarding to Laravel reviews:', apiUrl);
    ...
    console.log('Laravel reviews response status:', laravelResponse.status);
